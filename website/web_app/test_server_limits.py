...
class ServerLimitTests(unittest.TestCase):
    ...
    def test_homepage_starts_empty_and_examples_are_shared_between_inputs(self):
        ...
        self.assertIn('>Load example data<', html)
        self.assertIn('Choose disease and genes', html)
        self.assertIn('>Open a finished result<', html)
        self.assertIn('>More results ', html)
